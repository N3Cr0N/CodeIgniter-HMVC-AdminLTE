      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url(); ?>backend/boxed"><i class="fa fa-circle-o"></i> Boxed</a></li>
            <li class="active"><a href="<?php echo base_url(); ?>backend/fixed"><i class="fa fa-circle-o"></i> Fixed</a></li>
