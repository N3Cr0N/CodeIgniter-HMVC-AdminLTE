...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo base_url(); ?>backend/index2" class="logo">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>backend/index"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
            <li><a href="<?php echo base_url(); ?>backend/index2"><i class="fa fa-circle-o"></i> Dashboard v2</a></li>
          </ul>
        </li>
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>backend/top_nav"><i class="fa fa-circle-o"></i> Top Navigation</a></li>
            <li class="active"><a href="<?php echo base_url(); ?>backend/boxed"><i class="fa fa-circle-o"></i> Boxed</a></li>
            <li><a href="<?php echo base_url(); ?>backend/fixed"><i class="fa fa-circle-o"></i> Fixed</a></li>
            <li><a href="<?php echo base_url(); ?>backend/collapsed_sidebar"><i class="fa fa-circle-o"></i> Collapsed Sidebar</a></li>
          </ul>
        </li>
        <li>
          <a href="<?php echo base_url(); ?>backend/widgets">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url(); ?>backend/general"><i class="fa fa-circle-o"></i> General Elements</a></li>
            <li><a href="<?php echo base_url(); ?>backend/advanced"><i class="fa fa-circle-o"></i> Advanced Elements</a></li>
